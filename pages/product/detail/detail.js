 ...
 */
	...
	creatPoster() {
		...
		let getCode = new Promise((resolve, reject) => {
			app.query('/api/share/getacode', { scene: `video_id:${video.id},classify_id:${video.classify_id}`, width: 1280, page: '/pages/product/detail/detail' }, 'POST', 'arraybuffer').then(res => {
				console.log(res)
