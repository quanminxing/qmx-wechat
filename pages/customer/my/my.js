...
const ordersUrl = '../myorders/orders/orders'
    ...
    order: [
			{
				...
				text: '待付款',
				url: ordersUrl + '?trade_status=待付款&navCurrent=2',
				showFlag: true,
				flag: 0
			},
			{
				...
				text: '待确认',
				url: ordersUrl + '?trade_status=待确认&navCurrent=4',
				showFlag: true,
				flag: 0
			},
			{
				...
				text: '待寄送',
				url: ordersUrl + '?trade_status=待寄送&navCurrent=3',
				showFlag: true,
				flag: 0
			},
			{
				...
				text: '进行中',
				url: ordersUrl + '?trade_status=进行中&navCurrent=1',
				showFlag: true,
				flag: 0
			},
			{
				...
				text: '已完成',
				url: ordersUrl + '?trade_status=交易成功&navCurrent=5',
				showFlag: false,
				flag: 0
			},
			{
				...
				text: '售后',
				url: ordersUrl + '?trade_status=退款中,退款完成,交易关闭&navCurrent=6',
				showFlag: false,
				flag: 0
			}
		],
